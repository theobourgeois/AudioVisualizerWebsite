...
>(({ className, ...props }, ref) => (
    <SliderPrimitive.Root
        ...
        {...props}
    >
        <SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full bg-indigo-400/20 dark:bg-slate-50/20">
            <SliderPrimitive.Range className="absolute h-full bg-indigo-600 dark:bg-slate-50" />
